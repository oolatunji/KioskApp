...
function format(d) {
    ...
    return '<form><table width="100%" class="cell-border" cellpadding="5" cellspacing="0" border="2" style="padding-left:50px;">' +
        '<tr>' +
            ...
            '<td><input class="form-control" title="Branch Name" placeholder="Enter Branch Name" id="branchName" value="' + d.Name + '" required/></td>' +
        '</tr>' +
        '<tr>' +
            '<td style="color:navy;width:20%;font-family:Arial;">Code:</td>' +
            '<td><input class="form-control" title="Branch Code" placeholder="Enter Branch Code" id="branchCode" value="' + d.Code + '" required/></td>' +
        '</tr>' +
         '<tr>' +
            '<td style="color:navy;width:20%;font-family:Arial;">Address:</td>' +
            '<td><input class="form-control" title="Branch Address" placeholder="Enter Branch Address" id="branchAddress" value="' + d.Address + '" required/></td>' +
        '</tr>' +
        '<tr>' +
