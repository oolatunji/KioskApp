...
function format(d) {
    ...
    return '<form><table width="100%" class="cell-border" cellpadding="5" cellspacing="0" border="2" style="padding-left:50px;">' +
        '<tr>' +
            ...
            '<td><input class="form-control" title="Function Name" placeholder="Enter Function Name" id="name" value="' + d.Name + '" required/></td>' +
        '</tr>' +
        '<tr>' +
            '<td style="color:navy;width:20%;font-family:Arial;">Page Link:</td>' +
            '<td><input class="form-control" title="Page Link" placeholder="Enter Page Link" id="pageLink" value="' + d.PageLink + '" required/></td>' +
        '</tr>' +
        '<tr>' +
